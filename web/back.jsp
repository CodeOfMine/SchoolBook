...
<div class="container" id="center">
    <form action="${pageContext.request.contextPath}/backBookServlet" method="post">
        ...
        <div class="form-group">
            <input class="btn-primary" id="btn-back" type="submit" value="返还"/>
            <a id="back" href="${pageContext.request.contextPath}/bookListServlet">返回</a>
        </div>
    </form>
</div>
<div id="backMsg" class="alert alert-warning alert-dismissable" role="alert">
    <button type="button" class="close" data-dismiss="alert">
        <span>x</span>
    </button>
    <strong>${sessionScope.backInfoMsg}</strong>
</div>
</body>
</html>
