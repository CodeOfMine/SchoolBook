...
<div class="container" id="center">
    <form action="${pageContext.request.contextPath}/borrowServlet" method="post">
        ...
        <div class="form-group">
            <input class="btn-primary" id="btn-borrow" type="submit" value="借阅"/>
            <a id="back" href="${pageContext.request.contextPath}/bookListServlet">返回</a>
        </div>
    </form>
</div>
<div id="borrowInfo" class="alert alert-warning alert-dismissable" role="alert">
    <button type="button" class="close" data-dismiss="alert">
        <span>x</span>
    </button>
    <strong>${sessionScope.borrowInfoMsg}</strong>
</div>
</body>
</html>
